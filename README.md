...
| `lmin`    | 2         | `determinism`<br/>`avgdiag`<br/>`divergence`<br/>`entropy`<br/>`laminarity`<br/>`trappingtime` | Minimum length of the recurrent structures (diagonal or vertical) considered in the analysis. |
